...
export default class NavBar extends React.Component<NavBarProps, NavBarState> {
  ...
  render() {
    ...
    if (this.props.isAuthenticated) {
      SPLink = (
        <NavItem>
          <RouterNavLink to="/SPdata" className="nav-link" exact>News Feed</RouterNavLink>
        </NavItem>
      );
    }
    ...
    let SubscriptionLink = null;
      if (this.props.isAuthenticated) {
        SubscriptionLink = (
          <NavItem>
          <RouterNavLink to="/Subscriptions" className="nav-link" exact>Subscriptions</RouterNavLink>
        </NavItem>
        )
      }
    ...
    return (
      <div>
        <Navbar color="dark" dark expand="md" fixed="top">
          <Container>
            <NavbarBrand href="/">ShawNewsFeed</NavbarBrand>
